    ...
    <div class="cookie-modal__content">
        ...
        <form>
            ...
            <div class="cookie__section">
                ...
                <input class="js-cookie-performance" type="checkbox" name="CookiePerformance" id="performance" value="2" checked="checked">
                <label for="performance" id="performanceLabel" class="js-cookie-performance"> {{ trans('cookieConsent::texts.active_gdpr') }}</label>
            </div>
            <div class="cookie__section">
                ...
                <input class="js-cookie-marketing" type="checkbox" name="CookieMarketing" id="marketing" value="3" checked="checked">
                <label for="marketing" id="marketingLabel" class="js-cookie-marketing">{{ trans('cookieConsent::texts.active_gdpr') }}</label>
            </div>
        </form>
